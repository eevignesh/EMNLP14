...
public static void dummy(String[] arguments) throws Exception {
    ...
    String input = null;
    CuratorSRLClassifier srl = new CuratorSRLClassifier(configFile, verbNom);
...
public PredicateArgumentView getPredicateArguments(String input) throws Exception {
  boolean forceUpdate = false;
  ...
  // Nom SRL
  // _client.getNomView(ta, forceUpdate);
...
public PredicateArgumentView getOldPredicateArguments(String input) throws Exception {
  boolean forceUpdate = false;
  TextAnnotation ta = _client.getTextAnnotation("", "", input,
        forceUpdate);

  //TextPreProcessor.addViewsFromCurator(ta, _client, this.manager.defaultParser); 
  //PredicateArgumentView p = this.getSRL(ta);
...
.getLogger(CuratorSRLClassifier.class);

public final SRLManager manager;

/*public CuratorSRLClassifier(String configFile, String verbNom)
throws Exception {
...
TokenLabelView tlv = new TokenLabelView(ViewNames.POS, "CuratorSRLClassifier", ta, 1.0);
